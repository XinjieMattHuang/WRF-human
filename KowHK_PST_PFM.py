...
nc_path = 'F:/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/WRF-HEATS codes/output/Results_10m_8PM_deltaPFM.nc' # Change to calculated PST result nc file
...
pst_10m = np.array(loadnc.variables['PST_deltaPFM'][:,:])
...
satellite = plt.imread('F:/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/3. Results - Baseline, PFM, and slopes/plotting codes/Satellite_KowloonHK_inverted_BnW.png') # Change to your directory for Satellite_KowloonHK_inverted.png
...
cbar.set_label('△PST_PFM (°C)',fontsize=20) # You may edit the description of color bar 
...
plt.savefig('F:/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/3. Results - Baseline, PFM, and slopes/3.2 PFM/PST_10m_8PM_KowHK_BnW_jet.png',dpi=2000) # Change to your directory and graphs output path
