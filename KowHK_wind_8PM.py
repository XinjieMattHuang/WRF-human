...
nc_path = '/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/WRF-HEATS codes/output/Results_10m_8PM_tandq.nc' # Change to calculated PST result nc file
...
#plt.savefig('F:/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/3. Results - Baseline, PFM, and slopes/3.1 Baseline/Windandq_333m_8PM.png',dpi=2000) # Change to your directory and graphs output path

print('Completed !')

q_8PM_roads = mask_pst_roads.iloc[1450:2150,3200:4000].values.flatten()

q_8PM_openspace = mask_pst_openspace.iloc[1450:2150,3200:4000].values.flatten()

np.savetxt('F:/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/3. Results - Baseline, PFM, and slopes/3.1 Baseline/q_8PM_roads.csv', q_8PM_roads , delimiter=',')

np.savetxt('F:/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/3. Results - Baseline, PFM, and slopes/3.1 Baseline/q_8PM_openspace.csv', q_8PM_openspace , delimiter=',')