...
nc_path = 'F:/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/WRF-HEATS codes/output/Results_10m_8AM_deltaPFM.nc' # Change to calculated PST result nc file
...
plt.savefig('F:/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/3. Results - Baseline, PFM, and slopes/3.2 PFM/PST_10m_8AM_KowHK.png',dpi=2000) # Change to your directory and graphs output path
