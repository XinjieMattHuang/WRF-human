...
nc_path = '/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/WRF-HEATS codes/output/Results_10m_8AM_tandq.nc' # Change to calculated PST result nc file
...
pst_10m = np.array(loadnc.variables['XLAT'][:,:])
...
#plt.savefig('F:/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/3. Results - Baseline, PFM, and slopes/3.1 Baseline/Windandq_333m_8AM.png',dpi=2000) # Change to your directory and graphs output path

print('Completed !')

xlat_8AM_roads = mask_pst_roads.iloc[1450:2150,3200:4000].values.flatten()

xlat_8AM_openspace = mask_pst_openspace.iloc[1450:2150,3200:4000].values.flatten()

np.savetxt('F:/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/3. Results - Baseline, PFM, and slopes/3.1 Baseline/xlat_8AM_roads.csv', xlat_8AM_roads , delimiter=',')

np.savetxt('F:/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/3. Results - Baseline, PFM, and slopes/3.1 Baseline/xlat_8AM_openspace.csv', xlat_8AM_openspace , delimiter=',')