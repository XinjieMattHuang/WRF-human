...
nc_path = '/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/WRF-HEATS codes/output/Results_10m_8AM_baseline.nc' # Change to calculated PST result nc file
...
plt.savefig('/OneDrive - connect.hku.hk/Xinjie Huang/6 WRF+HEATS/Work/3. Results - Baseline, PFM, and slopes/3.1 Baseline/Wind_10m_8AM_wholeHK.png',dpi=1000) # Change to your directory and graphs output path
